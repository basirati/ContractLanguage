...
import com.mbeddr.analyses.cbmc.core.rt.analyses.asserts.AssertionsAnalyzerFactory;
...
public class VerifyFunctions_Action extends BaseAction {
  ...
  protected boolean collectActionData(AnActionEvent event, final Map<String, Object> _params) {
    ...
    }
    {
      ...
      if (node != null) {
        if (!(SNodeOperations.isInstanceOf(node, "com.mbeddr.core.modules.structure.Function"))) {
          node = null;
        }
      }
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      AssertionsAnalyzerFactory factory = new AssertionsAnalyzerFactory();
      CProverAnalysesUtils.performAnalysis(((IOperationContext) MapSequence.fromMap(_params).get("ctx")), ((SModel) MapSequence.fromMap(_params).get("model")), factory, conf, toolAdapter);
    } catch (Throwable t) {
      if (LOG.isEnabledFor(Level.ERROR)) {
